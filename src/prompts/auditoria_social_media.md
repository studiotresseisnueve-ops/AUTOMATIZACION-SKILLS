...
1. **Identifica qué falta** — nombra explícitamente qué datos no están en el documento (handles de redes sociales, plataformas activas, tipo de negocio, audiencia, etc.)
2. **Busca en internet** — usa web search con el nombre de la empresa + el dato faltante (ej. `"Empresa X Instagram"`, `"Empresa X redes sociales"`, `"Empresa X LinkedIn"`)
